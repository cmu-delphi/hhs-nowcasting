...
We plot nowcasts (backcasts at lag 5?) from different models
...
ggsave("../../../../paper/fig/monthly_update_examples.pdf", width = 8, height = 9)

ggarrange(plotlist = pl[2], nrow = 1, common.legend = TRUE, legend = "bottom")
ggsave("../../../../paper/fig/monthly_update_failure.pdf", width = 8, height = 3.25)
```