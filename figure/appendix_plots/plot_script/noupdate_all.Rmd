...
bl_preds = read.csv("../../../predictions/oneshot_omicron.csv") %>%
...
for (i in seq(1, length(states)-1, by = 3)) {
  ...
  cat(counter, paste(states[inds], collapse = ", "), "\n")
  ggarrange(plotlist = pl[inds], nrow = 3, common.legend = TRUE, legend = "bottom")
  ggsave(sprintf("../../plots/appendix/no_update_all_%i.pdf", counter),
        width = 8, height = 9)
}
```
