...
Abaltion with unweighted training on all past. The model still gets updated before 2022-01-01, and then 
gets frozen and just produces predictions untill 2023-08-01.
...
```{r}
tmp = state_get_test_oneshot_impute(as.Date("2023-01-01"))
```
