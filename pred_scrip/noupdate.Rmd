...
In this document we implement the oneshot model for the omicron wave
...
No retraining after 30 days of one shot, since we consider everthing to be finalized by then
