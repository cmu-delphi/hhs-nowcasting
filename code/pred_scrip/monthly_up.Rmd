...
In this document we implement the pipeline in which hhs data is now versioned
...
```{r}
gammas = signif(seq(0, 0.0625, length.out = 25), 3)[1:3]
alphas = signif(seq(0, 1, length.out = 51))[1:3]
