...
p1 = ggplot(qt_2_is) +
  ...
  geom_path(data = unwei_2_is, aes(x = backcast_lag, y = unwei_IS, color = "Weighted quantile")) +
  geom_ribbon(data = unwei_2_is, aes(x = backcast_lag, ymin = unwei_IS - unwei_se, ymax = unwei_IS + unwei_se,
              fill = "Weighted quantile"), alpha = transpar) +
  geom_path(data = wei_2_is, aes(x = backcast_lag, y = wei_IS, color = "Unweighted quantile")) +
  geom_ribbon(data = wei_2_is, aes(x = backcast_lag, ymin = wei_IS - wei_se, ymax = wei_IS + wei_se,
              fill = "Unweighted quantile"), alpha = transpar) +
...
p2 = ggplot(qt_2_cover) +
  ...
  geom_ribbon(aes(x = backcast_lag, ymin = coverage - se, ymax = coverage + se, 
               fill = "Quantile tracking"), alpha = transpar) +
  geom_path(data = unwei_2_cover, aes(x = backcast_lag, y = coverage, color = "Weighted quantile")) +
  geom_ribbon(data = unwei_2_cover, aes(x = backcast_lag, ymin = coverage - se, ymax = coverage + se,
              fill = "Weighted quantile"), alpha = transpar) +
  geom_path(data = wei_2_cover, aes(x = backcast_lag, y = coverage, color = "Unweighted quantile")) +
...
p1 = ggplot(qt_4_is) +
  ...
  geom_ribbon(aes(x = backcast_lag, ymin = qt_IS - qt_se, ymax = qt_IS + qt_se, 
               fill = "Quantile tracking"), alpha = transpar) +
  geom_path(data = unwei_4_is, aes(x = backcast_lag, y = unwei_IS, color = "Weighted quantile")) +
  geom_ribbon(data = unwei_4_is, aes(x = backcast_lag, ymin = unwei_IS - unwei_se, ymax = unwei_IS + unwei_se,
              fill = "Weighted quantile"), alpha = transpar) +
  geom_path(data = wei_4_is, aes(x = backcast_lag, y = wei_IS, color = "Unweighted quantile")) +
...
p2 = ggplot(qt_4_cover) +
  ...
  geom_ribbon(aes(x = backcast_lag, ymin = coverage - se, ymax = coverage + se, 
               fill = "Quantile tracking"), alpha = transpar) +
  geom_path(data = unwei_4_cover, aes(x = backcast_lag, y = coverage, color = "Weighted quantile")) +
  geom_ribbon(data = unwei_4_cover, aes(x = backcast_lag, ymin = coverage - se, ymax = coverage + se,
              fill = "Weighted quantile"), alpha = transpar) +
  geom_path(data = wei_4_cover, aes(x = backcast_lag, y = coverage, color = "Unweighted quantile")) +
